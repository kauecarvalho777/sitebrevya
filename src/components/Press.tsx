...
const outlets = [
  ...
  { name: "Portal Tela", logo: logoPortalTela, lightInvert: false, url: "https://www.portaltela.com/noticias/economia/2026/04/10/tecnologia-nas-empresas-evolui-e-impulsiona-novos-modelos-de-negocio/" },

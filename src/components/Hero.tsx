    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 pt-24 pb-16 max-w-5xl text-center">
        ...
        <TextGenerateEffect
          ...
          className="text-[1.55rem] sm:text-4xl md:text-5xl lg:text-[3rem] !leading-[1.1] tracking-tight text-foreground [&_span]:!bg-gradient-to-r [&_span]:!from-foreground [&_span]:!via-primary [&_span]:!to-foreground [&_span]:!bg-clip-text [&_span]:!text-transparent max-w-4xl mx-auto"
          duration={0.4}
        />
